...
pub use task::{
    ...
    PlannedEntryRef, PlannedTarget, PlannedTask, PlannedTaskRef, ResourceDomain, RunningTask,
    TaskCompletion, TaskContext, TaskContextError, TaskDependency, TaskFuture, TaskInvocation,
    TaskKind, TaskKindName, TaskKindNameError, TaskOutcome, TaskOutcomeKind, TaskOutput, TaskPlan,
