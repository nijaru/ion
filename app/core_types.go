...
var slashCommandDefs = []SlashCommandDefinition{
	...
	{
		Name:        "/memory",
		Description: "List, search, audit, forget, or restore workspace memory",
		Args:        "[search <query>|audit|forget <id>|restore <id>|all]",
		Idle:        -1,
	},
	{
		Name:        "/rewind",
		Description: "Preview or restore a workspace checkpoint",
		Args:        "[checkpoint-id [--apply]]",
		Idle:        SlashCommandIdleAlways,
	},
	{Name: "/status", Description: "Show runtime status", Idle: -1},
	{
		Name:        "/actions",
		Description: "List or reconcile unsettled external actions",
		Args:        "[reconcile <action-id> <completed|failed> <evidence>]",
		Idle:        SlashCommandIdleWithArgs,
	},
	{
		Name:        "/turns",
		Description: "List or discard interrupted turns",
		Args:        "[abort <turn-id>]",
		Idle:        SlashCommandIdleWithArgs,
	},
	...
	{Name: "/fork", Description: "Fork a new branch or show session tree", Args: "[summary]", Idle: -1},
	{Name: "/undo", Description: "Undo the last turn and restore prompt to composer", Idle: SlashCommandIdleAlways},
	...
	{
		Name:        "/search",
		Description: "Search conversation history with full-text search",
		Args:        "<query>",
		Idle:        -1,
	},
