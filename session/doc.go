...
//
// The domain model is provider-neutral. There is one Message type, discriminated
// by role. The provider wire format (llm.Message) is a boundary transform
// applied in the agent package, not a domain type stored here.
package session
