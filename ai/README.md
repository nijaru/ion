...
- [STATUS.md](STATUS.md) - current C2/C3 closeout, command/fork direction, active task, and latest evidence
- [PLAN.md](PLAN.md) - active Ion roadmap, completed core/harness work, and command/session next path
- [DESIGN.md](DESIGN.md) - product architecture, Ion/Canto ownership, command surface, timestamps, and harness boundary
...
- [TUI Architecture](specs/tui-architecture.md) - TUI shell, slash command surface, and rendering expectations
