...
| Python         | TypeScript              | Notes                  |
| -------------- | ----------------------- | ---------------------- |
| LangGraph      | Vercel AI SDK or Mastra | Agent orchestration    |
| LangChain      | Direct API calls        | Simpler, less overhead |
| Custom routing | AI SDK routing          | Multi-provider support |

**Decision**: Start with Vercel AI SDK for simplicity. Mastra if we need built-in memory/workflows.
