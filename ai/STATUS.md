...
1. Continue the table-stakes parity pass under `tk-mmcs` by selecting the next source-reviewed reliability slice from sessions/config/TUI, not ACP or experimental features.
