...
1. Select the next source-reviewed table-stakes reliability slice under `tk-mmcs`; likely candidates are one narrowly scoped TUI/session UX edge or deterministic provider/tool error coverage, not ACP or experimental features.
