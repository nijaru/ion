...
1. Start the TUI/replay gate under `tk-s6p4`: spacing, resumed marker placement, duplicate/error presentation, stale progress errors, and compact routine tool display in the actual terminal.
