...
- A3 storage surface is narrower: the unused legacy file-store implementation was removed so native Ion has one session storage path to audit, Canto-backed storage plus lazy materialization.
