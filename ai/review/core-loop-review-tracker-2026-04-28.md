...
1. TUI/replay manual bugs remain: resumed transcript presentation, stale progress/error presentation, and terminal polish.
...
- Remaining TUI gate work: verify stale progress/error clearing across provider/model/session changes and manually recheck resumed transcript presentation in a real terminal after any additional render changes.
