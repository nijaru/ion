...
Finish the design/context cleanup, then continue Ion refactors from the cleaned
...
| Phase | Goal | Status |
| --- | --- | --- |
| I0 | Close dirty baseline and clean AI context | Active |
| I1 | Refactor native core boundaries without behavior drift | Next |
| I2 | Polish minimal TUI/CLI shell for daily use | Next after I1 slices |
...
3. `tk-eyvq` - CantoBackend lifecycle files: construction/open, submit/cancel,
   event translation, compaction hooks, and deferred-surface guards.
4. `tk-7sna` - file tools split: read/write/edit/list responsibilities with
...
Focus only after I1 slices are green:
