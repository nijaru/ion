...
No structural K3 gap remains open: R1 ownership, R2 turn control and R3 fail-closed recovery are implemented, and the remaining work is the R4–R8 order in §1.
