...
**R1 is closed at `5bf3ea87`, R2 at `b4730bc8`, R3 at `9c19a331` (`8c91cb28` adds the process-death witness) and R4 at `d6fad545`**; R5–R8 are open. This table is the work-order authority; the K/P sections retain subsystem scope, not a competing execution sequence.
