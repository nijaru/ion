...
**R1 is closed at `5bf3ea87`, R2 at `b4730bc8`, R3 at `9c19a331` (`8c91cb28` adds the process-death witness), R4 at `d6fad545` (`aba6b92c` repairs the review's provenance findings) and R5 at `fa991317`**; R6–R8 are open. This table is the work-order authority; the K/P sections retain subsystem scope, not a competing execution sequence.
...
No structural K3 gap remains open: R1 ownership, R2 turn control and R3 fail-closed recovery are implemented, and R4 placement/attempts and R5 restart-safe observations have since closed too; the remaining work is the R6–R8 order in §1.
