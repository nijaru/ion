...
Still open: the worker control surface as commands (run/spawn, send/follow-up, inspect, wait, interrupt, retire), reuse of a retained worker, nested ownership limits, and retiring worker history.
